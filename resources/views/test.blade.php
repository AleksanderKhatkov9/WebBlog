...
<head>
    ...
    <noscript>
        <link rel="stylesheet" href="{{ asset('template/css/noscript.css') }}"/>
    </noscript>
</head>
...
<div id="page-wrapper">
    ...
    <header id="header" class="alt">
        ...
        <nav id="nav">
            <ul>
                <li class="current"><a href="../views/auth/login.blade.php">Welcome</a></li>
                <li class="submenu">
                    <a href="#">Layouts</a>
                    <ul>
        ...
        <section class="wrapper style3 container special">
            ...
            <div class="row">
                <div class="col-6 col-12-narrower">
                    ...
                    <section>
                        <a href="#" class="image featured"><img src="template/images/pic01.jpg" alt=""/></a>
                        <header>
                ...
                <div class="col-6 col-12-narrower">
                    ...
                    <section>
                        <a href="#" class="image featured"><img src="template/images/pic02.jpg" alt=""/></a>
                        <header>
            ...
            <div class="row">
                <div class="col-6 col-12-narrower">
                    ...
                    <section>
                        <a href="#" class="image featured"><img src="template/images/pic03.jpg" alt=""/></a>
                        <header>
                ...
                <div class="col-6 col-12-narrower">
                    <section>
                        <a href="#" class="image featured"><img src="template/images/pic04.jpg" alt=""/></a>
                        <header>
