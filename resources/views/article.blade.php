                                                                                                ...
                                                                                                <div class="container mt-3">
                                                                                                    <div class="card" style="">
                                                                                                        ...
                                                                                                        <div class="mb-3" id="content-style">
                                                                                                            ...
                                                                                                            <button type="button" class="btn btn-outline-primary" id="comment" style=" margin-left: 20px;">Оставить отзыв
                                                                                                            </button>
                                                                                                        </div>
                                                                                        ...
                                                                                        <div class="container mt-3">
                                                                                            <div class="card" style="width:1024px">
                                                                                                ...
                                                                                                <div class="mb-3" id="commit-div">
                                                                                                    ...
                                                                                                    <button type="button" class="btn btn-danger" name="com_cancel" id="com_cancel" style="margin-left: 20px;">Отмена
                                                                                                    </button>
                                                                                                </div>
